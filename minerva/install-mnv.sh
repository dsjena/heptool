...
function SetEnvFile() {
  ...
  echo "# Automatically Generated file " >> ${ENVFILE}
  echo "# Donot change it!! " >> ${ENVFILE}
...
function InstallCmake() {
   ...
   echo "#Appending CMAKE Variables" >> ${ENVFILE} 
...
echo -e ' \033[36m
------------------------------------------------------------------
          ___  ________ _   _  ___________        ___  
          |  \/  |_   _| \ | ||  ___| ___ \      / _ \ 
          | .  . | | | |  \| || |__ | |_/ /_   _/ /_\ \
          | |\/| | | | | . ` ||  __||    /\ \ / /  _  |
          | |  | |_| |_| |\  || |___| |\ \ \ V /| | | |
        ...
        --> Wecome to Installer script to install SPUtils <---   
------------------------------------------------------------------
\033[m'
}
#a--------------------------------- A21
function InstallBoost() {
  ...
  # ALWAYS Create the source file
  echo "#Appending BOOST Variables" >> ${ENVFILE} 
...
function InstallRoot() {
  ...
  # ALWAYS Create the source file
  echo "# Appending ROOT Variables" >> ${ENVFILE} 
  echo "# there are two ways to do it, choice is yours" >> ${ENVFILE} 
  echo "# Depending on the request and and requirement we will change this" >> ${ENVFILE} 
